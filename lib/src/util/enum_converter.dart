...
class EnumConverter {
  ...
  /// Convert [String] to [enum]. The [enumValues] must be passed
  /// by calling [EnumType.values]. For example if enum type is called
  /// 'Gender' then [Gender.values] should be passed to the [enumValues]
  /// parameter. Example usage of converting string to [Gender] type enum:
  ///
  /// {@tool sample}
  /// ```dart
  /// Gender gender = EnumConverter.toEnum<Gender>(Gender.values, 'Male');
  /// ```
  /// {@tool-end}
  ///
...
/// Helper static variable and functions for the [EnumConverter] class.
class _Helper {
  static const String _defaultPattern = _WORD;
  ...
  static const String _DIACRITICAL_MARK =
      r'\u0300-\u036F\u1AB0-\u1AFF\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F';
  ...
  static const String _DIGIT = r'\d';
  static const String _DINGBAT_BLOCK = r'\u2700-\u27BF';
  static const String _NON_CHAR =
      r'\x00-\x2F\x3A-\x40\x5B-\x60\x7b-\xBF\xD7\xF7';
  static const String _GENERAL_PUNCTUATION = r'\u2000-\u206F';
  static const String _WHITESPACE =
      r'\t-\r \x85\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000';
  static const String _WORD = '(?:[' +
      _UPPERCASE +
      '][' +
      _DIACRITICAL_MARK +
      ']*)?(?:[' +
